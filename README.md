...
El idioma predeterminado es español (`es`). Puedes cambiarlo en
...
`es`, para no romper configuraciones anteriores. Tras cambiar el idioma,
ejecuta `/mcreport reload` o reinicia el servidor.
